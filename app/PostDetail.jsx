    ...
    <View style={styles.screen}>
      ...
      <View style={{ alignItems: 'center', flexDirection: 'row', gap: 10 }}>
        ...
        <TouchableOpacity onPress={() => setShowPostDetail(false)}>
          ...
          <Image source={require("../assets/images/back.png")} style={styles.profileImage}/>
        </TouchableOpacity>
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.left}>
          <View style={styles.card}>
            ...
            <Image source={require("../assets/images/pic1.png")} style={styles.postImage}/>
          ...
          <View style={styles.commentSection}>
            ...
            {[1,2,3].map(i => (
              <View key={i} style={styles.commentRow}>
                ...
                <Image source={require("../assets/images/profile2.png")} style={styles.postIcon}/>
                <View>
