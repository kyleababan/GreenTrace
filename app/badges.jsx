...
export default function BadgesScreen() {
  ...
  const badges = useMemo(
    () => [
      ...contributorBadges.map((badge) => ({ ...badge, earned: true, contributor: true })),
      ...BADGES.map((badge) => ({ ...badge, earned: stats && isBadgeEarned(badge, stats) })),
    ],
