...
const getPostBarangay = (post) => {
  ...
  const usesCurrentFormat = (hasPurokSegment || Boolean(post.purok)) && parts.length >= 2;
...
export default function AssessmentList({
  ...
  const filteredPosts = useMemo(() => {
    ...
    return posts.filter((post) => {
      ...
      const resident = `${post.firstName || ""} ${post.lastName || ""}`.toLowerCase();
  ...
  const statusDetails = STATUS_DETAILS[status.toLowerCase()] || STATUS_DETAILS.pending;
                ...
                >
                  <View style={styles.authorRow}>
                    ...
                    <View style={styles.authorDetails}>
                      ...
                      >
                        <Text style={styles.statusText}>{postStatus.label}</Text>
                      </View>
                    </View>
                  </View>
...
const styles = StyleSheet.create({
  ...
  reactionRow: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 12 },
  priorityContainer: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  emptyText: { color: "#7A8A80", fontSize: 13, marginTop: 5, textAlign: "center" },
});
