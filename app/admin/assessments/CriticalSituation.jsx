console.log("CriticalSituation loaded");

import { Image, ScrollView, StyleSheet, Text, TouchableOpacity, View, useWindowDimensions } from 'react-native';

export default function CriticalSituation({ setShowPostDetail }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Critical Situation</Text>
            ...
            >
              ...
              <View style={styles.postReact}>
                <View style={styles.reactContainer}>
                  {/* <Image source={require("../../assets/PriorityReact.png")} style={styles.reactIcon} /> */}
...
const styles = StyleSheet.create({
  ...
  status: { width: 25, height: 25, borderRadius: 12.5, backgroundColor: '#FF6666', position: 'absolute', right: 5, top: 5, zIndex: 1 },
