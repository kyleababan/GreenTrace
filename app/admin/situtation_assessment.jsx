...
export default function SituationAssessment() {
  ...
  const [filters, setFilters] = useState({ purok: "", barangay: "", resident: "" });
      ...
      {!selectedPost && (
        <>
          ...
          <View style={styles.searchContainer}>
            <TouchableOpacity
              style={[styles.filterButton, enabledFilters.length > 0 && styles.filterButtonActive]}
            ...
            >
              ...
              {enabledFilters.length > 0 && (
                <View style={styles.filterCount}>
                  <Text style={styles.filterCountText}>{enabledFilters.length}</Text>
                </View>
              )}
            </TouchableOpacity>
            <TextInput
            ...
            <View style={styles.filterPanel}>
              <View style={styles.filterHeader}>
                <View>
                  ...
                  <Text style={styles.filterHint}>Select one or more filters.</Text>
                </View>
                {enabledFilters.length > 0 && (
                  <TouchableOpacity
                    onPress={() => {
              ...
              <View style={styles.filterOptions}>
                {[
                  ...
                  { id: "resident", label: "Residents", placeholder: "Enter resident name" },
                ].map((option) => {
                  ...
                  return (
                    <View key={option.id} style={styles.filterOption}>
                      <TouchableOpacity
                        style={[styles.filterChoice, isEnabled && styles.filterChoiceActive]}
                        onPress={() => {
                      ...
                      >
                        ...
                        />
                        <Text style={[styles.filterChoiceText, isEnabled && styles.filterChoiceTextActive]}>
                          {option.label}
                        </Text>
                      </TouchableOpacity>
                      ...
                      {isEnabled && (
                        <TextInput
                          ...
                          onChangeText={(value) =>
                            setFilters((current) => ({ ...current, [option.id]: value }))
                          }
...
const styles = StyleSheet.create({
  ...
  filterChoice: { flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: 7 },
